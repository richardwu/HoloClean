...
arguments = [
    ...
    (('-dtp', '--domain-top-percentile'),
     {'metavar': 'DOMAIN_TOP_PERCENTILE',
      'dest': 'domain_top_percentile',
      'default': 1.0,
      'type': float,
      'help': 'Take union of domain values in the top X% of co-occurrence probabilities per correlated attribute as the candidate domain for a given cell.'}),
    (('-dt2', '--domain-thresh-2'),
     {'metavar': 'DOMAIN_THRESH_2',
      'dest': 'domain_thresh_2',
      'default': 0,
      'type': float,
      'help': 'Threshold of posterior probability required for candidate domain values to be included in the final domain in the second domain pruning stage. Between 0 and 1.'}),
